const flowers = [
      { id: 'f1', name: 'Red Rose Bouquet', price: 699, desc: '12 premium red roses with baby\'s breath', img: 'red_rose.jpeg', discount: '10% OFF' },
      { id: 'f2', name: 'Sunflower Sunshine', price: 549, desc: '8 bright sunflowers with eucalyptus', img: 'sunflower.jpeg', discount: '15% OFF' },
      { id: 'f3', name: 'Pink Paradise', price: 799, desc: 'Mixed pink carnations, lilies & orchids', img: 'pink_lilies.jpeg', discount: '20% OFF' },
      { id: 'f4', name: 'Lavender Dream', price: 649, desc: 'Fresh lavender bundles with white daisies', img: 'daisies.jpeg', discount: '10% OFF' },
      { id: 'f5', name: 'Tropical Burst', price: 899, desc: 'Exotic anthuriums & birds of paradise', img: 'birds_of_paradise.jpeg', discount: '15% OFF' },
      { id: 'f6', name: 'White Elegance', price: 1199, desc: 'Premium white lilies & orchid arrangement', img: 'white_lilies.jpeg', discount: '20% OFF' },
      { id: 'f7', name: 'Rainbow Wildflower', price: 599, desc: 'Seasonal wildflowers in vibrant mix', img: 'wildflowers.jpeg', discount: '10% OFF' },
      { id: 'f8', name: 'Tulip Garden', price: 749, desc: 'Dutch tulips in spring pastels', img: 'tulip.jpeg', discount: '15% OFF' }
    ];
